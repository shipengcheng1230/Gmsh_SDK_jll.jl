...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Gmsh_SDK_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4abbd9bc-5e42-58f8-a031-9aef3230cdd8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Gmsh_SDK", artifacts_toml) for e in artifacts["Gmsh_SDK"]]
...
if best_platform === nothing
    @debug("Unable to load Gmsh_SDK; unsupported platform $(triplet(platform_key_abi()))")
else
